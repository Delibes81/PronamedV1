      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Av. Reforma 247, Col. Juárez</li>
              <li className="text-gray-400">Ciudad de México, CP 06600</li>
              <li className="text-gray-400">Tel: +52 (55) 5555-5555</li>
              <li className="text-gray-400">Email: info@pronamed.com</li>
            </ul>
          </div>
        </div>
